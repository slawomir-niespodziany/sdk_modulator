...
{Niespodziany \MakeLowercase{\textit{et al.}}: Algorithmic scale factor control optimization for interferometric fiber optic gyroscope}
\definecolor{abstractbg}{rgb}{0.89804,0.94510,0.83137}
\setlength{\fboxrule}{0pt}
\setlength{\fboxsep}{0pt}

\begin{document}
\title{Algorithmic optimization of scale factor control precision with an all--digital modulator for interferometric fiber optic gyroscope}
