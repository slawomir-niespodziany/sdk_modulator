...
\begin{equation}
    e_{2k+1}
    = -\frac{P_0 \cdot \pi}{8} \cdot (\underbrace{\delta_{2k+1}}_{\text{current error}} + \underbrace{3 \cdot \delta_{2k+0} + \delta_{2k-1} + 3 \cdot \delta_{2k-2}}_{\text{last three errors}})
...
\begin{table}[h]
    ...
    \begin{tabular}{ccccc}
        \toprule
        $\phi_{2k+1}$ ($\times1$) & $\phi_{2k+0}$ ($\times3$) & $\phi_{2k-1}$ ($\times1$) & $\phi_{2k-2}$ ($\times3$) & $e_{2k+1} [-\frac{P_0 \cdot \pi}{8} \cdot \Delta\phi_{min}]$ \\
        \midrule
        0                         & 0                         & 0                         & 0                         & 0                                                            \\
        \midrule
        \rowcolor{gray!15}
