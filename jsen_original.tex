    ...
    \fcolorbox{abstractbg}{abstractbg}{%
        \begin{minipage}{\textwidth}%
            \begin{wrapfigure}[12]{r}{3in}%
                \includegraphics[width=3in]{img/jsenga.png}%
            \end{wrapfigure}%
            \begin{abstract}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{img/a1.png}}]{First A. Author} (M'76--SM'81--F'87) and all authors may include
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{img/a2.png}}]{Second B. Author} was born in Greenwich Village, New York, NY, USA in
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{img/a3.png}}]{Third C. Author, Jr.} (M'87) received the B.S. degree in mechanical
